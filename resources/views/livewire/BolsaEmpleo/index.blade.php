<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px6 lg:px-8">
        ...
        <button  onclick="window.location.href='/BolsaEmpleopdf'" class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 my-3" >PDF</button>
        @if($modal)
            @include('livewire.BolsaEmpleo.crear')   
        @endif    
        ...
        <thead>
            <tr class="bg-indigo-600 text-white">
                ...
                <th class="px-4 py-2">FECHA_CREACION</th>
                <th class="px-4 py-2">FECHA_ELIMINACION</th>
                <th class="px-4 py-2">POSTULANTES</th>
        ...
        @foreach($empleos as $empleo)
            <tr>
                ...
                <td class="border px-4 py-2 text-center">
                    <button wire:click="editar({{$empleo->BDE_ID}})" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4">Editar</button>
                    <button wire:click="borrar({{$empleo->BDE_ID}})" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4">Borrar</button>
                </td>
            </tr>
        @endforeach
        </tbody>
